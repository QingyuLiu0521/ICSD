...
**Please note that our paper is currently under review. We will make all data publicly available once the paper is accepted. After the paper is received, you can download the audio files and metada from our provided source URL list on [Huggingface](https://huggingface.co/datasets/QingyuLiu1/ICSD)**
